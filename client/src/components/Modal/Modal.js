                ...
                >
                  <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="row mt-4">
                      <div className="flex ">
                        <div className="ms-2">
                          <button className="bg-red-500 hover:bg-red-600 flex p-2 rounded-xl text-white relative">
                            <svg
                        ...
                        <div className="ms-3">
                          <button className="bg-blue-500 hover:bg-blue-600 flex p-2 rounded-xl text-white relative" onClick={closeModal}>
