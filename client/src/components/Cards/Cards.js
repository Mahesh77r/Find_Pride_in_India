  ...
  return (
    <>
      <div className="rounded bgf  border border-solid border-cyan-800 item-center overflow-hidden shadow-lg transition-transform hover:scale-105">
        ...
        {/* Image */}
        <div className="row ">
          <img className="w-100 h-30 py-2 px-5" alt="Events " src={hosp} />
        </div>
        {/* Facility Title */}
        <div className="text-2xl my-2 font-bold text-center">
          {fac_name}
...
<div className="row my-3">
          <div className="flex justify-between">
            <div className="ms-3">
              <button className="bg-purple-500 hover:bg-purple-600 flex p-2 rounded-full text-white relative" onClick={openModal}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div className="me-3">
              <button className="bg-red-500 hover:bg-red-600 flex p-2 rounded-full text-white relative" onClick={openModal}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
