    ...
    <div className="rounded bgf overflow-hidden shadow-lg transform transition-transform hover:scale-105">
      ...
      <div className="row my-3">
        <div className="flex justify-between">
          <div className="ms-3">
            <button className="bg-purple-500 hover:bg-purple-600 flex p-2 rounded-full text-white relative">
              <svg
          ...
          <div className="me-3">
            <button className="bg-red-500 hover:bg-red-600 flex p-2 rounded-full text-white relative">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
