...
import { addProduct } from '../../services/domCRUD';
...
export const FormProduct = ({ img_url, prod_name, prod_price, prod_quant, prod_desp }) => {
    ...
    return (
        <>
            <Alert bgcolor={'blue-300'} bool={showalert} desc={"Complete all the fields"} onClose={handleCloseAlert} title={'Fill Fields'} />
            <form onSubmit={onSubmitHandler}>
                ...
                {/* <!-- product Name Input --> */}
                <div className="mb-4">
                    <label htmlFor="prod_name" className="block text-gray-700 text-sm font-bold mb-2">Name of Product</label>
                    <input type="text" id="prod_name" onChange={onChangeHandler} value={prod_name} name="product_name" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500" placeholder="Enter the product name" required />
                </div>
                {/* product catergory dropdown */}
                <div className="mb-4">
                    <label htmlFor="prod_category" className="block text-gray-700 text-sm font-bold mb-2">Category of Product</label>
                    <select id="prod_category" onChange={onChangeHandler} name="category" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500" required>
                ...
                {/* <!-- product Price Input --> */}
                <div className="mb-4">
                    <label htmlFor="prod_price" className="block text-gray-700 text-sm font-bold mb-2">Price of Product</label>
                    <input type="number" id="prod_price" onChange={onChangeHandler} value={prod_price} name="product_price" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500" required inputMode="numeric" />
                </div>

                {/* <!-- product Quantity Input --> */}
                <div className="mb-4">
                    <label htmlFor="prod_quantity" className="block text-gray-700 text-sm font-bold mb-2">Quantity of Product</label>
                    <input type="number" id="prod_quantity" onChange={onChangeHandler} value={prod_quant} name="quantity_available" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500" required inputMode="numeric" />
                </div>

                {/* <!-- product Description Input --> */}
                <div className="mb-4">
                    <label htmlFor="prod_description" className="block text-gray-700 text-sm font-bold mb-2">Description of Product</label>
                    <textarea id="prod_description" onChange={onChangeHandler} value={prod_desp} name="product_descp" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500" rows="4" placeholder="Enter a description htmlFor the product" required></textarea>
                </div>
